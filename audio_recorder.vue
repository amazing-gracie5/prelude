<!-- Code from https://github.com/zauberzeug/nicegui/tree/main/examples/audio_recorder/ for audio_recorder.py and audio_recorder.vue
Authors: Mansar Youness and Falko Schindler -->
